 ...
 (dt/leader-keys
  ...
  (dt/leader-keys
    ...
    "m m" '((lambda () (interactive) 
	    ...
	    :wk "toggle org markers")
    "m l" '(org-toggle-link-display :wk "Org toggle link display")
  )
...
(setq grip-sleep-time 1)

(setq browse-url-generic-program "firefox")


;; eaf
;(add-to-list 'load-path "~/era/site-lisp/emacs-application-framework/")
;(require 'eaf)
;(require 'eaf-browser)
