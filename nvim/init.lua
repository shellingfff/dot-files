...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>dc', dap.continue, { desc = 'Begin Debug' })
      vim.keymap.set('n', '<leader>dsc', dap.step_over, { desc = 'Step Over' })
      ...
      dap.adapters.codelldb = {
        ...
        port = '${port}',
        executable = {
          command = '/home/mint/.local/share/nvim/mason/bin/codelldb', -- adjust as needed, must be absolute path
          args = { '--port', '${port}' },
        },
        name = 'lldb',
      }
